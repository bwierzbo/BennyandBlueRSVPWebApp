...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${inter.className} ${playfair.variable} font-sans`}>
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-white focus:text-wedding-roseGold-500 focus:rounded focus:shadow-lg focus:outline-none focus:ring-2 focus:ring-wedding-roseGold-500"
        >
          Skip to content
        </a>
        {children}
