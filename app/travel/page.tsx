...
export default function TravelPage() {
  ...
  return (
    <main id="main-content" className="min-h-screen bg-gradient-to-br from-wedding-dustyPink-50 to-wedding-lavender-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-3 mb-4">
            <svg className="w-10 h-10 text-wedding-roseGold-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8">
            <div className="flex items-center mb-4">
              <div className="p-2 bg-orange-100 dark:bg-orange-900/30 rounded-lg mr-3">
                <svg className="w-6 h-6 text-orange-600 dark:text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8">
            <div className="flex items-center mb-4">
              <div className="p-2 bg-wedding-roseGold-100 dark:bg-wedding-roseGold-900/30 rounded-lg mr-3">
                <svg className="w-6 h-6 text-wedding-roseGold-600 dark:text-wedding-roseGold-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8">
            ...
            <div className="border-b border-gray-200 dark:border-gray-700 mb-6">
              <nav className="flex gap-4" role="tablist" aria-label="Accommodation types">
                <button
                  role="tab"
                  id="tab-hotels"
                  aria-selected={activeTab === 'hotels'}
                  aria-controls="tabpanel-hotels"
                ...
                <button
                  role="tab"
                  id="tab-airbnbs"
                  aria-selected={activeTab === 'airbnbs'}
                  aria-controls="tabpanel-airbnbs"
                ...
                <button
                  role="tab"
                  id="tab-bnbs"
                  aria-selected={activeTab === 'bnbs'}
                  aria-controls="tabpanel-bnbs"
            ...
            <div className="space-y-6 text-gray-700 dark:text-gray-300">
              {activeTab === 'hotels' && (
                <div role="tabpanel" id="tabpanel-hotels" aria-labelledby="tab-hotels" className="space-y-4">
                  <p className="text-gray-600 dark:text-gray-400">
              ...
              {activeTab === 'airbnbs' && (
                <div role="tabpanel" id="tabpanel-airbnbs" aria-labelledby="tab-airbnbs" className="text-center py-8">
              ...
              {activeTab === 'bnbs' && (
                <div role="tabpanel" id="tabpanel-bnbs" aria-labelledby="tab-bnbs" className="text-center py-8">
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <div className="bg-wedding-lavender-50 dark:bg-gray-800 border border-wedding-lavender-200 dark:border-gray-700 rounded-lg p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
              <div className="flex items-center gap-2 text-sm">
                <svg className="w-5 h-5 text-wedding-roseGold-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
