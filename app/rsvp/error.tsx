  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-wedding-dustyPink-50 to-wedding-lavender-100 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
        <div className="mb-6">
          <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-wedding-roseGold-100 flex items-center justify-center">
            <svg
              className="w-8 h-8 text-wedding-roseGold-600"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <p className="text-gray-600">
            We had trouble loading the RSVP form. Please try again.
          </p>
        </div>
